...
-- local Host = 'server2.jamera.com.br'
local Host = '192.168.0.104'
local Port =  7171
local GameVersion = 761
...
function EnterGame.init()
  ...
  --end
  --clientBox:setCurrentOption(GameVersion)

  EnterGame.toggleAuthenticatorToken(GameVersion, true)
  EnterGame.toggleStayLoggedBox(GameVersion, true)
...
function EnterGame.onClientVersionChange(comboBox, text, data)
  EnterGame.toggleAuthenticatorToken(GameVersion)
  EnterGame.toggleStayLoggedBox(GameVersion)
end
...
function EnterGame.doLogin()
  ...
  g_settings.set('client-version', GameVersion)
  ...
  g_game.setClientVersion(GameVersion)
  g_game.setProtocolVersion(g_game.getClientProtocolVersion(GameVersion))
